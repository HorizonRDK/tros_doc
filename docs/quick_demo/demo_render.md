...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| RDK X3, RDK X3 Module, RDK J5| Ubuntu 20.04  | 启动MIPI摄像头人体检测并通过Web展示图像和算法效果 |
...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| RDK X3, RDK X3 Module, RDK J5| Ubuntu 20.04  | 启动MIPI摄像头获取图像，在PC上使用RViz2预览 |
...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| RDK X3, RDK X3 Module, RDK J5| Ubuntu 20.04  | 启动MIPI摄像头获取图像，在PC上使用RQt预览 |
