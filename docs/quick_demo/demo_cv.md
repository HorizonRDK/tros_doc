...
| 平台    | 运行方式     | 示例功能                       |
| ------- | ------------ | ------------------------------ |
| 地平线RDK| Ubuntu 20.04 | 读取ToF图片，进行高斯滤波 |
...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| 地平线RDK| Ubuntu 20.04  | 读取ToF图片，进行均值滤波 |
...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| 地平线RDK| Ubuntu 20.04  | 读取图片，进行金字塔缩放 |
