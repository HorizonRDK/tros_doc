...
安装tros.b之前，建议用户将地平线RDK系统镜像升级到最新版本，U2buntu 20.04镜像烧录方法：[Ubuntu镜像烧录方法](https://developer.horizon.ai/api/v1/fileData/documents_rdk/getting_start/quick_start.html#id2)
